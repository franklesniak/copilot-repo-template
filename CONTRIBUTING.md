...
| --- | --- | --- |
| Pre-commit | `.github/workflows/pre-commit.yml` | Validates pre-commit hooks pass on all files |
...
| Python CI | `.github/workflows/python-ci.yml` | Runs Black, Ruff, mypy, and pytest on Python files |
