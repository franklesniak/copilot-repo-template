...
This section is retained as Codex platform protocol. Thin-entry-point pruning must preserve it unless the repository owner explicitly waives Codex GitHub plugin protocol for the retained Codex entry point. That preservation requirement is an interpretation of the canonical **Agent Instruction Files** section and creates no exception to it.
...
This section is retained as Codex platform protocol. Thin-entry-point pruning must preserve it unless the repository owner explicitly waives Codex PR review protocol for the retained Codex entry point. That preservation requirement is an interpretation of the canonical **Agent Instruction Files** section. Where this section and its subsections state how the canonical **Protected Instruction Files** rule applies to review-driven work, they are interpretations of that rule and create no exception to it.
