...
This file intentionally keeps only a minimal repository-specific summary so that Claude receives critical guidance immediately, but it does not replace reading the canonical instructions above.
